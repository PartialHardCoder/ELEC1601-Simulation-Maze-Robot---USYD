...
void robotAutoMotorMove(struct Robot * robot, int front_centre_sensor, int left_sensor, int right_sensor) {
    ...
    if (turning_right == 1) {
      ...
      //  else {
       ...
       // }
    ...
    else if ((left_sensor > 3) && (right_sensor == 0) && (front_centre_sensor == 0)){
            turning_right = 1;
            printf("Triggered right turn");
        }
        ...
        if ((front_centre_sensor > 0) && (left_sensor == 0)){
            robot->currentSpeed = 0;
        ...
        else if ((front_centre_sensor > 0)&& (left_sensor >0)){
            if (front_centre_sensor > 1){
                robot->currentSpeed = 0;
                robot->direction = DOWN;
            }
    ...
    /*
        ...
        else if ((front_centre_sensor > 0)&& (right_sensor >0)){
            turning_left = 1;
            printf("Triggered left turn");
        }
        else if ((front_centre_sensor > 0) && (right_sensor == 0)){
    ...
    */
    ...
    else if ((front_centre_sensor == 0)&& (robot->currentSpeed == 0)){
        robot->direction = UP;
    }
}
