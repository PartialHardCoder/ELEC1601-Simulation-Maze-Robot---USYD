...
int main(int argc, char *argv[]) {
    ...
    //BASIC MAZE, make sure you have correct if (checkRobotReachedEnd) on line 271
    ...
    insertAndSetFirstWall(&head, name_index++,  130, 00, 10, 90);
    //END OF BASIC MAZE
/* COMPLEX MAZE
 ...
 m = 90;
    ...
    */
    ...
    while(!done){
       ...
       //COMPLEX MAZE if (checkRobotReachedEnd(&robot, 0, 180, 10, 60)){
       //BASIC MAZE
       if (checkRobotReachedEnd(&robot, 30, 0, 100, 10)){
            end_time = clock();
